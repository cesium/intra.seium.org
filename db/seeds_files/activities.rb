	...
	def self.activities(editions, speakers)
		Activity.create!([
			...
			},
			{
				...
				end_date: DateTime.civil_from_format(:local, 2015, 2, 18, 19, 30),
			...
			},
			{
				...
				url_escaped_name: CGI::escape(I18n.transliterate('Rally das Tascas'.gsub(/(\s+|\.+)/, '-').downcase)),
				begin_date: DateTime.civil_from_format(:local, 2015, 2, 18, 21, 30),
				end_date: DateTime.civil_from_format(:local, 2015, 2, 19, 0, 0),
				activity_type: ActivityType::LOUNGE,
				place: 'Largo do Carpe',
				edition: editions[0]
			},
			{
				...
				end_date: DateTime.civil_from_format(:local, 2015, 2, 16, 10, 0),
			...
			},
			{
				...
				begin_date: DateTime.civil_from_format(:local, 2015, 2, 16, 10, 30),
			...
			{
				name: 'Espaço Seegno & Bitreserve',
				url_escaped_name: CGI::escape(I18n.transliterate('Espaço Seegno & Bitreserve'.gsub(/(\s+|\.+)/, '-').downcase)),
				begin_date: DateTime.civil_from_format(:local, 2015, 2, 16, 18, 0),
				end_date: DateTime.civil_from_format(:local, 2015, 2, 16, 19, 0),
				activity_type: ActivityType::MEET,
				place: 'DI A2',
				edition: editions[0]
			},
			{
				name: 'Espaço Vilt',
				url_escaped_name: CGI::escape(I18n.transliterate('Espaço Vilt'.gsub(/(\s+|\.+)/, '-').downcase)),
				begin_date: DateTime.civil_from_format(:local, 2015, 2, 19, 18, 0),
				end_date: DateTime.civil_from_format(:local, 2015, 2, 19, 19, 0),
				activity_type: ActivityType::MEET,
				place: 'DI A2',
				edition: editions[0]
			},
			...
			},
			{
				...
				end_date: DateTime.civil_from_format(:local, 2015, 2, 19, 13, 0),
				activity_type: ActivityType::TALK,
				place: 'DI A2',
				edition: editions[0],
			...
			},
			{
				...
				end_date: DateTime.civil_from_format(:local, 2015, 2, 19, 15, 30),
				activity_type: ActivityType::WORKSHOP,
				place: 'DI A2',
			...
			{
				name: 'Impressão 3D',
				url_escaped_name: CGI::escape(I18n.transliterate('Impressão 3D'.gsub(/(\s+|\.+)/, '-').downcase)),
				begin_date: DateTime.civil_from_format(:local, 2015, 2, 19, 15, 30),
				end_date: DateTime.civil_from_format(:local, 2015, 2, 19, 16, 30),
				activity_type: ActivityType::TALK,
				place: 'DI A2',
				speakers: [find_speaker(speakers, 'Francisco Mendes')],
				edition: editions[0]
			},
			{
				...
				end_date: DateTime.civil_from_format(:local, 2015, 2, 19, 18, 0),
				activity_type: ActivityType::TALK,
				place: '',
			...
			},
			{
				...
				begin_date: DateTime.civil_from_format(:local, 2015, 2, 19, 21, 0),
			...
			{
				name: 'Arraial das Engenharias',
				url_escaped_name: CGI::escape(I18n.transliterate('Arraial das Engenharias'.gsub(/(\s+|\.+)/, '-').downcase)),
				begin_date: DateTime.civil_from_format(:local, 2015, 2, 19, 19, 30),
				end_date: DateTime.civil_from_format(:local, 2015, 2, 19, 21, 0),
				activity_type: ActivityType::LOUNGE,
				place: 'Largo do Carpe',
				edition: editions[0]
			},
			{
				...
				url_escaped_name: CGI::escape(I18n.transliterate('Jantar de Encerramento'.gsub(/(\s+|\.+)/, '-').downcase)),
				begin_date: DateTime.civil_from_format(:local, 2015, 2, 20, 21, 30),
				end_date: DateTime.civil_from_format(:local, 2015, 2, 21, 0, 0),
				activity_type: ActivityType::LOUNGE,
				place: 'Restaurante Panorâmico',
				edition: editions[0]
			},
			{
			...
			},
			{
				...
				end_date: DateTime.civil_from_format(:local, 2015, 2, 14, 19, 0),
				activity_type: ActivityType::SOCIAL,
				place: 'DI A2',
				edition: editions[0],
			...
			},
			{
				...
				end_date: DateTime.civil_from_format(:local, 2015, 2, 17, 13, 0),
				activity_type: ActivityType::TALK,
				place: 'DI A2',
			...
			{
				name: 'The Meteor Shower, From Prototype To Production',
				url_escaped_name: CGI::escape(I18n.transliterate('The Meteor Shower, From Prototype To Production'.gsub(/(\s+|\.+)/, '-').downcase)),
